...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Runner Core runner-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  runner-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded runner transaction") + "\n" +
              "  runner-tx [options] -create [commands]   " + _("Create hex-encoded runner transaction") + "\n" +
              "\n";
