    ...
    cachedNodeid(-1)
{
...
#ifndef Q_OS_MAC
    ui->openDebugLogfileButton->setIcon(QIcon(":/icons/export_focus"));
#endif
    ...
    // some reason hide the openssl and berkeleyDBVersion
    ui->label_berkeleyDBVersion->hide();
    ui->berkeleyDBVersion->hide();

    ui->label_14->hide();
    ui->openSSLVersion->hide();
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Runner RPC console.") + "<br>" +
