...
### Download the Blockchain from the RunnerNode Project

The Runner node project provides multiple and regulaly updated direct-link downloads. Copies of bootstrap.dat can be downloaded directly from servers provided by RunnerNode, or be downloaded from a randomly selected server. All copies of boootstrap are updated at the maximum of every six months.

**Copies of Bootstrap from a specific server**

* [http://mango.runnernode.org/bootstrap.dat](http://mango.runnernode.org/bootstrap.dat)
* [http://apple.runnernode.org/bootstrap.dat](http://apple.runnernode.org/bootstrap.dat)

**Randomly selected dopy of Bootstrap**

This could be useful for use in scripts.

* [http://bootstrap.runnernode.org/bootstrap.dat](http://bootstrap.runnernode.org/bootstrap.dat)
	
**Example usage in a (bash) Terminal**

	wget http://bootstrap.runnernode.org/bootstrap.dat       //downloads bootstrap into current directory
